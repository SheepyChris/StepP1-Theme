...
t[#t+1] = LoadActor("_preview")..{
	...
	OnCommand=cmd(stoptweening;y,145;sleep,.1;linear,.2;y,165);
	StartSelectingSongMessageCommand=cmd(stoptweening;y,145;diffusealpha,0;sleep,.25;linear,.1;y,165;diffusealpha,1);
	GoBackSelectingGroupMessageCommand=cmd(stoptweening;y,165;diffusealpha,1;sleep,.2;linear,.1;y,145;diffusealpha,0);
	OffCommand=cmd(stoptweening;y,165;diffusealpha,1;sleep,.2;linear,.1;y,145;diffusealpha,0);
...
t[#t+1] = LoadActor( THEME:GetPathG("","ScreenSelectMusic/fulllevel_"..PLAYER_1.."_stepball") )..{
	InitCommand=cmd(y,SCREEN_BOTTOM-105;x,SCREEN_CENTER_X-90;basezoom,.67);
...
t[#t+1] = LoadActor("_diff_FM.lua")..{
	...
	StartSelectingStepsMessageCommand=cmd(stoptweening;playcommand,"ShowUp";y,SCREEN_BOTTOM+100;linear,.2;y,SCREEN_BOTTOM-105;queuecommand,'HideOffCommand'); 	
	GoBackSelectingSongMessageCommand=cmd(stoptweening;playcommand,"Hide";y,SCREEN_BOTTOM-105;sleep,.2;linear,.1;y,SCREEN_BOTTOM+100;queuecommand,'HideOnCommand');
	OffCommand=cmd(stoptweening;y,SCREEN_BOTTOM-105;sleep,.2;linear,.2;y,SCREEN_BOTTOM+100);
...
t[#t+1] = LoadActor("_diffbar_full")..{
	...
	OnCommand=cmd(stoptweening;diffusealpha,0;y,320;sleep,.45;linear,.2;y,285;diffusealpha,1);
	StartSelectingSongMessageCommand=cmd(stoptweening;diffusealpha,0;y,310;sleep,.45;linear,.2;y,285;diffusealpha,1);
	GoBackSelectingGroupMessageCommand=cmd(stoptweening;diffusealpha,1;y,285;zoom,1;linear,.2;y,310;diffusealpha,0);
	StartSelectingStepsMessageCommand=cmd(stoptweening;diffusealpha,1;y,285;zoom,1;sleep,.1;linear,.1;zoom,1.25;y,292);
	GoBackSelectingSongMessageCommand=cmd(stoptweening;zoom,1.25;y,292;sleep,.1;linear,.1;zoom,1;y,285);
	OffCommand=cmd(stoptweening;diffusealpha,1;sleep,.05;linear,.2;y,310;diffusealpha,0);
